  ...
  const data = [
    {
      ...
      risk_score: (
        <div className="flex justify-center items-center">
          <div className="bg-[var(--color-green)] h-[29px] w-[29px] flex justify-center items-center text-[white] text-3xl font-medium rounded-[3px]">1</div>
          <div>
      ...
      copy: (
        <span onClick={handleContentClick}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" id="copy" width="24" height="24" fill="var(--color-red)">
            ...
            />
            <path fill="none" stroke="var(--color-red)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" d="M55,29V57a2,2,0,0,1-2,2H25a2,2,0,0,1-2-2V48" />
          </svg>
        </span>
      ),
      action: (
        <div className="flex justify-center items-center gap-5" onClick={handleContentClick}>
          ...
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="var(--color-green)" className="w-6 h-6">
